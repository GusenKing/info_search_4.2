...
def search_mode(search_args):
    print("Loading index...")
    # index = load_index(search_args.index_file)
    #
...
if __name__ == '__main__':
    ...
    build_parser.add_argument("--output_filepath", default="Task3Results/inverted_index.json",
    ...
    search_parser.add_argument("index_file", help="Path to saved index")
